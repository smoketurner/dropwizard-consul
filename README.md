...
* The Dropwizard service is registered as a Consul service with a Consul-side health check querying the Dropwizard [health check](http://www.dropwizard.io/1.1.2/docs/manual/core.html#health-checks)
...
Usage
-----
Add a `ConsulBundle` to your [Application](http://www.dropwizard.io/1.1.2/dropwizard-core/apidocs/io/dropwizard/Application.html) class.
...
Example Application
-------------------
This bundle includes a modified version of the `HelloWorldApplication` from Dropwizard's [Getting Started](http://www.dropwizard.io/1.1.2/docs/getting-started.html) documentation.
...
```
mvn clean package
java -jar consul-example/target/consul-example-1.1.3-2-SNAPSHOT.jar server consul-example/hello-world.yml
```
